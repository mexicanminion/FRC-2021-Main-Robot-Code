...
//    private static XboxController controllerDr;
 ...
 /*   if (Robot.useJoysticks() == true){
  ...
  public void zeroJoySticks(){
    leftXOffSet = driveJoystick.getX(Hand.kLeft);
    leftYOffSet = driveJoystick.getY(Hand.kLeft);
    rightXOffSet = driveJoystick.getX(Hand.kRight);
    rightYOffSet = driveJoystick.getY(Hand.kRight);
  ...
  public double getControllerStickLeft(){
    double hand = -driveJoystick.getY(Hand.kLeft) + leftYOffSet;
  ...
  public double getControllerStickRight(){
    double hand = -driveJoystick.getY(Hand.kRight) + rightYOffSet;
